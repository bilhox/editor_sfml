...
void ui::Entry::set_visibleLines(){
...
void ui::Entry::set_visibleLinePortion(unsigned int line){
...
void ui::Entry::resize(sf::Vector2f size){
...
void ui::Entry::updateScrollbar(ui::Direction direction){
...
unsigned long ui::Entry::getMaxLineWidth(){
